...
- 用户表（[用户表源码](graph/用户表.md)）
  ![用户表](graph/用户表.png){width=300px}

- 商品表（[商品表源码](graph/商品表.md)）
  ![商品表](graph/商品表.png){width=300px}

- 库存表（[库存表源码](graph/库存表.md)）
  ![库存表](graph/库存表.png){width=300px}

- 订单表（[订单表源码](graph/订单表.md)）
  ![订单表](graph/订单表.png){width=300px}

- 整体ER图（[整体ER图源码](graph/整体ER图.md)）
  ![整体ER图](graph/整体ER图.png){width=300px}
...
![商品详情界面](graph/shop.png){width=500px}
...
![查询成功界面](graph/search_success.png){width=500px}
...
![查询失败界面](graph/search_failed.png){width=500px}
